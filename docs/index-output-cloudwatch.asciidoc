...
Key-value pairs of settings and corresponding values used to parameterize
the connection to cloudwatch. See full list in https://docs.aws.amazon.com/sdkforruby/api/Aws/CloudWatch/Client.html[the AWS SDK documentation]. Example:
